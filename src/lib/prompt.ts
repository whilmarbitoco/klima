...
export const createChatPromptRAG = (
  ...
  ## Contextual Data
  Use the following relevant information to guide your responses:
  Data from RAG pipeline: 
  ${context}
  ...
  5. **Length:** Be brief and conversational, like you're talking to a farmer during a quick check-in.
  `;
};
